...
export const styles = StyleSheet.create({
  ...
  buttonText: { color: '#fff', fontSize: 16, fontWeight: '600' },
    ...
    selectionButtonDanger: { backgroundColor: '#D94F4F' },
    ...
    selectionButtonTextDanger: { color: '#fff', fontSize: 12, fontWeight: '700' },
    ...
    modalTitle: { fontSize: 16, fontWeight: '700', marginBottom: 4, flexShrink: 1, paddingRight: 8 },
    modalRemainingCount: { fontSize: 12, fontWeight: '700', color: '#D94F4F', backgroundColor: 'rgba(217,79,79,0.1)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10, overflow: 'hidden' },
