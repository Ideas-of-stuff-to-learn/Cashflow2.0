// customHooks/homescreen/categorizationConfig.js
...
export const LLM_BATCH_SIZE = 400;
export const MIN_LLM_BATCH_SIZE = 200;
export const LLM_CHUNK_SIZE = Math.max(MIN_LLM_BATCH_SIZE, LLM_BATCH_SIZE);
...
export const TIMEOUT_SAFETY_BUFFER_SECONDS = 10;
export const CLIENT_TIMEOUT_MS = Math.max(1, WORKER_TIMEOUT_SECONDS - TIMEOUT_SAFETY_BUFFER_SECONDS) * 1000;
...
export const GEMINI_REQUEST_TIMEOUT_MS = 30000;
